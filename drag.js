...
let blocks = [
	...
	{type: "block", ref: document.getElementsByClassName('block')[0], inPins: [], outPins: [1, 1]},
	{type: "block", ref: document.getElementsByClassName('block')[1], inPins: [1, null, 1], outPins: [1]},
